...
var sample$$1 = curry2(function (event, behavior) { return behavior.sample(event); });
...
Constant.prototype.sample = function sample$$1 (stream) {
...
Stepper.prototype.sample = function sample$$1 (stream) {
...
Map.prototype.sample = function sample$$1 (stream) {
  return map$3(this.f, this.behavior.sample(stream))
};
...
LiftA2.prototype.sample = function sample$$1 (stream) {
...
var numberValue = pipe(always, map$$1(pipe(function (input$$1) { return input$$1.value; }, Number)));

var x = numberValue(byId('x'));
var y = numberValue(byId('y'));
var z = liftA2(function (x, y) { return x + y; }, x, y);

var inputEvents = input(byId('container'));

var render = function (el) { return function (result) { return el.value = result; }; };

sample$$1(inputEvents, z).observe(render(byId('z')));
